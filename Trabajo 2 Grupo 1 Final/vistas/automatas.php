              ...
              <form action="index.php?pagina=estados" method="POST">
                <?php
                  echo 'Ingrese tipo de autómata:<br>
                        <select class="casillainput" name="tipo_auto">    
                        <option value="2afd">2 AFD </option>    
                        <option value="1afnd">1 AFD y 1 AFND</option>    
                        <option value="2afnd">2 AFND</option></select>
                        <br><br>';    
                        
                  echo '<input class="casillainput" type="text" size="25" name="cantidad_estados_1" placeholder="N°estados del 1° Automatas" required pattern="[0-9]{1,2}">
                        <input class="casillainput" type="text" size="25" name="cantidad_estados_2" placeholder="N°estados del 2° Automatas" required pattern="[0-9]{1,2}">
                        <br>
                        ';
